...
The re-usable roles and tasks that will be executed on the nominated clients to apply the hardening profile are located in the project `roles/` directory and are resolved automatically via `roles_path` in `ansible.cfg`.



Now, inspect the roles included in the project `roles/` directory
...
```yaml
---
v_report_server: "<your-report-server-hostname>"
v_report_server_port: "22"
v_report_server_user: "*your username*"
v_report_server_pass: "*your password*"
```
>This is very important to ensure your scan jobs ships the report to your home directory on the report server. 
...
`oscap-report-<hostname>-preharden.html`


copy the `html` report local to your workstation 

```bash
scp -P 22 <username>@<report-server>:/home/*<studentID>*/oscap-report-<hostname>-preharden.html .
```
