# Windows Server 2016 CIS Benchmark

Ansible role to apply the CIS Benchmark for Windows Server 2016.

## Upstream Source

<https://github.com/ansible-lockdown/Windows-2016-CIS>
...
ansible-playbook soe-win2016-cis-hardenning.yml --tags "level1-memberserver"

# Run all Level 2 controls
ansible-playbook soe-win2016-cis-hardenning.yml --tags "level2-domaincontroller,level2-memberserver"
```
