# Windows Server 2022 CIS Benchmark

Ansible role to apply the CIS Benchmark for Windows Server 2022.
...
ansible-playbook soe-win2022-cis-hardenning.yml --tags "level1-memberserver"

# Run all Level 2 controls
ansible-playbook soe-win2022-cis-hardenning.yml --tags "level2-domaincontroller,level2-memberserver"
```
