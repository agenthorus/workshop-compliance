...
Ansible role to apply the CIS Benchmark for Windows Server 2025.
...
ansible-playbook soe-win2025-cis-hardenning.yml --tags "level1-memberserver"

# Run all Level 2 controls
ansible-playbook soe-win2025-cis-hardenning.yml --tags "level2-domaincontroller,level2-memberserver"
```
